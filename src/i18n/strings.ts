...
const en = {
  ...
  inspectorNotesPlaceholder: 'Presenter notes for this slide (Markdown)…',
  inspectorNotesBold: 'Bold',
  inspectorNotesBullet: 'Bullet list',
  inspectorNotesHeading: 'Heading',
  inspectorNotesPreview: 'Preview',
  inspectorNotesEditor: 'Editor',
  inspectorNotesViewMode: 'Notes view',
...
const es: Record<keyof typeof en, string> = {
  ...
  inspectorNotesPlaceholder: 'Notas del presentador para esta diapositiva (Markdown)…',
  inspectorNotesBold: 'Negrita',
  inspectorNotesBullet: 'Lista con viñetas',
  inspectorNotesHeading: 'Encabezado',
  inspectorNotesPreview: 'Vista previa',
  inspectorNotesEditor: 'Editor',
  inspectorNotesViewMode: 'Vista de notas',
